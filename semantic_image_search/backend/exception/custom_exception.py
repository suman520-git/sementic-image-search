...
class SemanticImageSearchException(Exception):
    ...
    def __repr__(self):
        return f"SemanticImageSearchException(file={self.file_name!r}, line={self.lineno}, message={self.error_message!r})"
...
#         raise SemanticImageSearchException("Division failed", e) from e

#     # Demo-2: still supports sys (old pattern)
#     # try:
#     #     a = int("abc")
#     # except Exception as e:
#     #     raise SemanticImageSearchException(e, sys)